...
int moistureSensorPin = A1; // Moisture sensor analog int motorDriverPinA = 2; // Motor driver pin 1 (forward)
...
void loop() {
int rainSensorValue = analogRead(rainSensorPin); // int moistureSensorValue = analogRead(moistureSensorPin); Serial.print("Rain sensor value: ");
...
else if ( heavyRainThreshold < rainSensorValue && moistureSensorValue {
...
delay(2000); // Open roof for 5 seconds
}
